...
export default function FloatingBackground() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-gradient-to-br from-amber-100 via-rose-100 to-orange-100 opacity-55 blur-3xl animate-float-fast" />
      ...
      {particles.map((particle, index) => (
        <span
          ...
          className={`absolute rounded-full bg-white/90 shadow-[0_0_25px_rgba(15,185,177,0.25)] ${particle.size} ${particle.animation}`}
