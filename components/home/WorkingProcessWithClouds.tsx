    ...
    <section className="relative bg-transparent py-16 md:py-24">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10">
        <svg
          ...
          className="h-20 w-full text-cyan-100/60 md:h-24"
          fill="none"
          aria-hidden="true"
        >
          <path
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-white/65 bg-white/28 p-8 backdrop-blur-2xl shadow-[0_30px_90px_-50px_rgba(99,102,241,0.38)] md:p-10">
